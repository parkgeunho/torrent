...
<script type="text/javascript">
	...
	function sendIt() {
	    ...
	    f.action = "<%=cp%>/sboard/updated_ok.do${params}&num=${dto.num}";
	    f.submit();
	}
...
<form action="" name="myForm" method="post" enctype="multipart/form-data">
	<table class="" border="0" align="center" style="padding-bottom:10px; font-size: 15px; width: 1000px;">
		...
		<tr>
			...
			<td width="500">
				<input type="text" value="${dto.subject }" name="subject" size="67" maxlength="130" class="boxTF"/></td></tr>	
		...
		<tr>
			...
			<td width="500">
				<input style="border-width: 0;" type="text" name="userId" size="50" maxlength="100" class="boxTF" value="${dto.userId}" readonly="readonly"/></td></tr>
		<tr>
			<td style="width: 600px; height: 1px;" bgcolor="#E4E4E4" colspan="2"></td></tr>	
		<tr>	
			<td align="center" width="100"  height="40" style="color: #242424">첨부&nbsp;파일</td>
			<td>
				<input type="file" value="${dto.saveFileName }" class="filestyle" data-placeholder="No file" data-size="sm" name="upload"/></td></tr>
		...
		<tr>
			...
			<td>
			<textarea name="content" rows="12" cols="70" class="boxTA">${dto.content }</textarea></td></tr>
	...
	<table align="center" border="0">
		...
		<tr>
			...
			<td width="50" ><button type="button" class="btn btn-default" style="height: 35px; width: 80px;" 
					onclick="javascript:location.href='<%=cp%>/sboard/board.do${params}';">수정취소</button></td></tr>
	</table>			
